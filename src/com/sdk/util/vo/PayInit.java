...
public class PayInit implements java.io.Serializable {
	...
	@Expose
	private String appId; // 初化的密钥对ID
	@Expose
	private String appkey; // 初化的密钥对Key
	@Expose
	private String appCode; // 初化时的Code(一般只需要前2个，有些可能有三个初数华)
	@Expose
	private String callBack; // 后台的回调地址
	@Expose
	private String model; // 支付的类型,多个用英文逗号分隔　sdk,sms
	@Expose
	private String factory; // 支付的执行类
	@Expose
	private List<PayPoint> pointList; // 计费点列表
