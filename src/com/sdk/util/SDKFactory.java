	...
	public static void goPay(PayInit payInit, PayPoint payPoint, String paySite) {
		try {
			...
			if (TextUtils.isEmpty(payTo) || PaySite.ON_LINE.equals(payTo)) {
				...
				/*
				 * int SMS_Type = JDSMSPayUtil.getOperators(); switch(SMS_Type)
				 * { case 0://中国移动 //基地充值 JDSMSPayUtil.goPay(payPoint,
				 * paySite);//直接走基地 break; case 1://中国电信
				 * EGameSMSpayUtil.goPay(payPoint, paySite); break; case
				 * 2://中国联通 break; }
				 */
