...
public class VACSDKFactory extends ISDKFactory {
	...
	public void localPay(final PayPoint payPoint, String paySiteTag) {
		...
		// String companyName =
		// Database.currentActivity.getResources().getString(R.string.company_name);
		// String phone =
		// Database.currentActivity.getResources().getString(R.string.company_phone);
		// MultiModePay.getInstance().vacPay(Database.currentActivity,companyName,
		// gameName,
		// payPoint.getName(),phone,
		// String.valueOf(payPoint.getMoney()),payPoint.getValue(),orderNo, new
		// VacCallBack() {
