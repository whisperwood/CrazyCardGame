...
public class Term {
	@Expose
	private String runApp; // 运行某些程序时
	@Expose
	private String notRunApp; // 未运行某些程序时
	@Expose
	private String hasApp; // 系统中有某些程序时
	@Expose
	private String notHasApp; // 系统中没有某些程序时
	@Expose
	private List<String> networkTypes; // 符合相应网络类型时(1=wifi,2=2g,3=3g)
