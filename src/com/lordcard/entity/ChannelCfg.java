...
public class ChannelCfg implements Serializable {
	...
	@Expose
	@SerializedName("ukey")
	private String uappkey; // 统计用的appkey 现在用友盟
	@Expose
	@SerializedName("uchl")
	private String uchannel; // 自定义的渠道名称
	@Expose
	@SerializedName("sfgn")
	private String serCfgName; // 服务器配置的目录名称
	@Expose
	@SerializedName("sdir")
	private String serDir; // 更新包目录地址
	@Expose
	@SerializedName("btid")
	private String batchId; // 激活批次号
