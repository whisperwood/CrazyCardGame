...
public class PlayCardAnima {
	...
	public static AnimationDrawable createAnimDrawAble() {
		...
		for (int i = 2; i < (Constant.ANIM_FRAME_COUNT + 2); i++) {
			Drawable drawable = ImageUtil.getResDrawableByName(
					Constant.ANIM_IMAGE_START + i, true, true);
	...
	public static AnimationDrawable createEndWin() {
		animationDrawable = new AnimationDrawable();
		for (int i = 1; i < (2 + 1); i++) {
			Drawable drawable = ImageUtil.getResDrawableByName(Constant.END_WIN
					+ i, true, true);
	...
	public static AnimationDrawable createBomb() {
		...
		for (int i = 0; i < 7; i++) {
			Drawable drawable = ImageUtil.getResDrawableByName(
					Constant.BOMB_IMAGE_START + i, true, true);
	...
	public static AnimationDrawable createDizhuSmile() {
		animationDrawable = new AnimationDrawable();
		for (int i = 0; i < 5; i++) {
			Drawable drawable = ImageUtil.getResDrawableByName(
					Constant.BOMB_IMAGE_START + i, true, true);
	...
	public static AnimationDrawable createShunz() {
		...
		for (int i = 1; i <= 10; i++) {
			Drawable drawable = ImageUtil.getResDrawableByName(
					Constant.SHUNZ_IMAGE_START + i, true, true);
	...
	public static AnimationDrawable createWangBomb() {
		...
		for (int i = 0; i < 6; i++) {
			Drawable drawable = ImageUtil.getResDrawableByName(
					Constant.WANG_BOMB_IMAGE_START + i, true, true);
	...
	public static AnimationDrawable createPoint() {
		...
		for (int i = 2; i < 4; i++) {
			Drawable drawable = ImageUtil.getResDrawableByName(
					Constant.POINT_ANIM + i, true, true);
			animationDrawable.addFrame(drawable, 200);
		}
		animationDrawable.setOneShot(false); // 设置是否循环播放 false:循环播放
		return animationDrawable;
	...
	public static AnimationDrawable createImageNew() {
		...
		for (int i = 1; i < 3; i++) {
			Drawable drawable = ImageUtil.getResDrawableByName(
					Constant.IMAGE_NEW_ANIM + i, true, true);
			animationDrawable.addFrame(drawable, 200);
		}
		animationDrawable.setOneShot(false); // 设置是否循环播放 false:循环播放
		return animationDrawable;
	...
	public static AnimationDrawable createImageNews() {
		...
		for (int i = 0; i < 4; i++) {
			Drawable drawable = ImageUtil.getResDrawableByName(
					Constant.IMAGE_NEWS_ANIM + i, true, true);
			animationDrawable.addFrame(drawable, 200);
		}
		animationDrawable.setOneShot(false); // 设置是否循环播放 false:循环播放
		return animationDrawable;
	...
	public static AnimationDrawable createImageLingZhiDou() {
		...
		for (int i = 1; i < 3; i++) {
			Drawable drawable = ImageUtil.getResDrawableByName(
					Constant.IMAGE_LING_ZHI_DOU_ANIM + i, true, true);
			animationDrawable.addFrame(drawable, 200);
		}
		animationDrawable.setOneShot(false); // 设置是否循环播放 false:循环播放
		return animationDrawable;
	...
	public static AnimationDrawable createBaoXiang() {
		...
		for (int i = 1; i < 4; i++) {
			Drawable drawable = ImageUtil.getResDrawableByName(
					Constant.BAO_XIANG + i, true, true);
	...
	public static void loadPlayCard() {
		String[] cartType = new String[] { Constant.CARD_TAO,
				Constant.CARD_XIN, Constant.CARD_MEI, Constant.CARD_FANG };
