/**
 * PatternUtils.java [v 1.0.0]
 * classes : util.PatternUtils
 * auth : yinhongbiao
 * time : 2012 2012-11-6 下午10:49:32
 */
...
public class PatternUtils {
	...
	public static boolean isEmail(String email) {
		...
		if (p.matcher(email).matches() && !p1.matcher(email).matches()) {
			return true;
		}
		return false;
	}
	 ...
	 * @return
	 */
	public static boolean hasIllegalWords(String words) {
		String regEx = "[`~!@#$%^&*()+=|{}':;',\\[\\].<>/?~！@#￥%……&*（）——+|{}【】‘；：”“’。，、？]";
		Pattern p1 = Pattern.compile(regEx);
		Matcher m = p1.matcher(words);
		if (m.find()) {
			return true;
		}
		return false;
	 ...
	 * @return
	 */
	public static String changeZhidou(long zhidou) {
		String result = "";
		if (zhidou > 100000) {
			zhidou = zhidou / 10000;
			result = String.valueOf(zhidou) + "W";
		} else if (zhidou < -100000) {
			zhidou = zhidou / 10000;
			result = String.valueOf(zhidou) + "W";
		} else {
			result = String.valueOf(zhidou);
		}
		return result;
	}
	...
	public static String formatIqBeans(long iqBeans) {
		StringBuilder resultbBuilder = new StringBuilder();
		if (iqBeans < 10000) {
			resultbBuilder.append(iqBeans);
		} else if (iqBeans >= 10000) {// && iqBeans <= 999999) {
			/** 100W以内 **/
			if (iqBeans % 10000 == 0) {
				resultbBuilder.append(iqBeans / 10000);
			} else {
				double temp = iqBeans / 10000.0;
				long tempLong = (long) (temp * 10);
				if (tempLong % 10 == 0)
					resultbBuilder.append(tempLong / 10);
				else
					resultbBuilder.append(tempLong / 10f);
			}
			resultbBuilder.append("万");
		}
		// else if (iqBeans >= 1000000) {
		// resultbBuilder.append(iqBeans / 1000000);
		// resultbBuilder.append("百万");
		// }
		return resultbBuilder.toString();
	}
