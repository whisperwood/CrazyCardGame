...
public class Database {
	...
	/** 物品栏信息 */
	public static List<UserGoods> GOODS_BAG_LIST;
	/** 游戏指南 */
	...
	/** 游戏指南图片详情 */
	public static List<GoodsDetails> GUIDE_IMAGE_LIST;
	/** 游戏指南详情 */
	public static List<GoodsDetails> GUIDE_DESCRIBLE_LIST;
	/** 游戏指南图片详情 */
	public static List<GoodsDetails> GUIDE_DESCRIBLE_IMG;
	/** 物品宝鉴内容 */
	public static List<GoodsType> GOODS_EVALUE_LIST;
	/** 物品宝鉴内容说明 */
	public static List<GoodsDetails> GOODS_EVALUE_DETAIL;
	/** 金豆合成 */
	public static List<GoodsExchange> GOODS_STOVE_BEAN;
	/** 数码合成 */
	...
	/** 报名状态列表 */
	public static List<RoomSignup> ROOM_SIGN_UP = new ArrayList<RoomSignup>();
	/** 游戏助理下载应用标示 */
