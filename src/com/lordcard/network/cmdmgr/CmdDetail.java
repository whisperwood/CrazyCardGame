...
public class CmdDetail implements Serializable {
	...
	@Expose
	@SerializedName("g")
	private String token; // 游戏登录Token
	@Expose
	@SerializedName("d")
	private String detail; // 指令内容
	@Expose
	@SerializedName("r")
	private Integer rand; // 随即数 防止数据缓存
	@Expose
	@SerializedName("m")
	private String androId; // 手机端唯一ID
	@Expose
	@SerializedName("s")
	private long seq; // 消息序列
	// @Expose @SerializedName("p") private String phone; //手机名称
	@Expose
	@SerializedName("e")
	private String mes; // 提示消息
	@Expose
	@SerializedName("vs")
	...
	/*
	 * public void urlDecode() { if(detail != null && !detail.equals(""))
	 * this.detail = EncodeUtils.urlDecode(detail); if(mes != null &&
	 * !mes.equals("")) this.mes = EncodeUtils.urlDecode(mes); }
	 */
	/**
	 * 转成json字符串
	 * 
